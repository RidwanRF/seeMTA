...
function CreateButton(Name, Text, PosX, PosY, SizeX, SizeY, Color)
	if Name and Text and PosX and PosY and SizeX and SizeY and Color then
		...
		dxDrawRectangle(PosX, PosY, SizeX, SizeY, tocolor(ButtonData[1], ButtonData[2], ButtonData[3], ButtonData[4] * SantaAlpha))
		dxDrawText(Text, PosX + SizeX / 2, PosY + SizeY / 2, nil, nil, tocolor(200, 200, 200, 240 * SantaAlpha), 0.8, SeeFont, "center", "center")
	end
end
