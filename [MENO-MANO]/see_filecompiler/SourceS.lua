...
addCommandHandler("compileresfiles", 
	function(Player, Command, ResourceName)
		if ResourceName then
			...
			if Resource then
				local Files = getFilesInResourceFolder("Files/Images/", Resource)
				...
				if Files then
					for Key, Value in pairs(Files) do
						...
						local NewPath = utf8.gsub(Value, ".png", ".Strong")
						...
						local FileName = utf8.gsub(NewPath, "Files/Images/", "")
						local FileName = utf8.gsub(FileName, ".Strong", "")
