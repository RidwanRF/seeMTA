availableItems = {
	...
	[156] = {"Ajándék", "Ajándék, tele meglepetésekkel", 0.25, false, -1, -1},
	...
	[318] = {"Kulcstartó", "kucstato", 0.1, false, -1, -1},
...
function isKeyItem(itemId)
	if itemId <= 3 or itemId == 154 or itemId == 119 or itemId == 318 then
		return true
	end
	return false
end
