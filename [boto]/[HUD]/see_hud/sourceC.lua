								...
								if plateText then
									...
									if x and y and dist < 25 then
										...
										if licenseExpire[veh] then
											...
											if #expire >= 3 then
												if getTimestamp() >= getTimestamp(expire[1], expire[2], expire[3], 0, 0, 0) then
												...
												dxDrawText(expire[1] .. "\n" .. expire[2] .. "." .. expire[3], x + sx - sx2 + sx2 / 2, y + sy / 2, nil, nil, tocolor(255, 255, 255, 255 * alpha), scale * 0.75, Roboto, "center", "center")
